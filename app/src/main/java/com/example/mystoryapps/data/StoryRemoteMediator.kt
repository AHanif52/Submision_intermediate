...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            val responseData = apiService.getStories(page, state.config.pageSize, LOCATION, "Bearer $token")

            var story: List<ListStoryItem> = listOf()

            if (responseData.listStory != null) {
                story = responseData.listStory!!
            }
